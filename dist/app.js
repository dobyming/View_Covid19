...
var deathsTotal = $('.deaths'); // type assertion
...
function fetchCountryInfo(country, status) {
    // country : 국가 이름 들어감
    // params: confirmed, recovered, deaths (3가지만 받음)
    var url = "https://api.covid19api.com/country/".concat(country, "/status/").concat(status);
    return axios_1.default.get(url);
}
// methods
function startApp() {
...
function renderChart(data, labels) {
    ...
    auto_1.default.defaults.color = '#f5eaea';
